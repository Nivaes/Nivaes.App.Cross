...
namespace Nivaes.App.Mobile.Sample
{
        ...
        : MvxViewModel
    {
        ...
        private string[] mCatImageUrls = new[]
        {
        ...
        private string[] mDogImageUrls = new[]
        {
        ...
        private string[] mMonkeyImageUrls = new[]
        {
        ...
        private AnimalViewModel CreateRandomAnimal()
        {
            ...
            var name = mNames[mRandom.Next(0, mNames.Length - 1)];
            var color = _colors[mRandom.Next(0, _colors.Length - 1)];
            ...
            switch (mRandom.Next(0, 3))
            {
                case 0: // Cat
                    ...
                    {
                        Name = name,
                        ImageUrl = mCatImageUrls[mRandom.Next(0, mCatImageUrls.Length - 1)],
                        FavoriteColor = color
                    };
                ...
                case 1: // Dog
                    ...
                    {
                        Name = name,
                        ImageUrl = mDogImageUrls[mRandom.Next(0, mDogImageUrls.Length - 1)],
                        FavoriteColor = color
                    };
                ...
                case 2: // Monkey
                    ...
                    {
                        Name = name,
                        ImageUrl = mMonkeyImageUrls[mRandom.Next(0, mMonkeyImageUrls.Length - 1)],
                        FavoriteColor = color
                    };
