...
namespace Nivaes.App.Cross.Droid.RecyclerView
{
    ...
    [Register("nivaes.app.MvxRecyclerAdapter")]
        ...
        : AndroidX.RecyclerView.Widget.RecyclerView.Adapter, IMvxRecyclerAdapter, IMvxRecyclerAdapterBindableHolder
    {
        ...
        public ICommand ItemClick
        {
            ...
            set
            {
                ...
                if (_itemClick != null && value != null)
                    MvxBindingLog.Instance.Warn("Changing ItemClick may cause inconsistencies where some items still call the old command.");
        ...
        public ICommand ItemLongClick
        {
            ...
            set
            {
                ...
                if (_itemLongClick != null && value != null)
                    MvxBindingLog.Instance.Warn("Changing ItemLongClick may cause inconsistencies where some items still call the old command.");
        ...
        public virtual object GetItem(int viewPosition)
        {
            ...
            if (ItemsSource is IList items)
            {
                ...
                MvxBindingLog.Instance.Error($"MvxRecyclerView GetItem index out of range. viewPosition:{viewPosition} itemsSourcePosition:{itemsSourcePosition} itemCount:{_itemsSource.Count()}");
        ...
        protected virtual void SetItemsSource(IEnumerable value)
        {
            if (Looper.MainLooper != Looper.MyLooper())
                MvxBindingLog.Instance.Error("ItemsSource property set on a worker thread. This leads to crash in the RecyclerView. It must be set only from the main thread.");
        ...
        protected virtual void OnItemsSourceCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (Looper.MainLooper == Looper.MyLooper())
                ...
                MvxBindingLog.Instance.Error("ItemsSource collection content changed on a worker thread. This leads to crash in the RecyclerView as it will not be aware of changes immediatly and may get a deleted item or update an item with a bad item template. All changes must be synchronized on the main thread.");
        }
