...
namespace MvvmCross.Plugin.Visibility
{
    ...
    public abstract class MvxBaseVisibilityValueConverter
        : MvxValueConverter
    {
        private IMvxNativeVisibility? mNativeVisiblity;

        private IMvxNativeVisibility NativeVisibility => mNativeVisiblity ??= Mvx.IoCProvider.Resolve<IMvxNativeVisibility>();
