...
public class FragmentPresentationAttribute
    : BasePresentationAttribute
{
    ...
    Type? activityHostViewModelType = null,
        ...
        PopBackStack popBackStackImmediateFlag = PopBackStack.Inclusive,
    ...
    public static PopBackStack DefaultPopBackStackImmediateFlag { get; } = PopBackStack.Inclusive;

    /// <summary>
    /// Flag to be used with PopBackStackImmediate. 
    /// </summary>
    public PopBackStack PopBackStackImmediateFlag { get; set; } = DefaultPopBackStackImmediateFlag;
