namespace Nivaes.App.Cross
{
    ...
    public class CrossCommandCollectionBuilder
    : ICrossCommandCollectionBuilder
    {
        ...
        public virtual ICrossCommandCollection BuildCollectionFor(object owner)
        {
            var toReturn = new CrossCommandCollection(owner);
            CreateCommands(owner, toReturn);
            return toReturn;
        }

        [RequiresUnreferencedCode("This method uses reflection which may not be preserved during trimming")]
        protected virtual void CreateCommands(object owner, CrossCommandCollection toReturn)
        {
            var commandMethods =
                from method in
                    owner.GetType()
        ...
        protected virtual void CreateCommand(
            object owner, CrossCommandCollection collection, MethodInfo commandMethod,
        ...
        protected CrossCommandAttribute? CommandAttribute(MethodInfo method)
        {
            return (CrossCommandAttribute?)method.GetCustomAttributes(typeof(CrossCommandAttribute), true).FirstOrDefault();
        }
        ...
        public abstract class MvxBaseCommandBuilder : ICrossCommandBuilder
        {
            ...
            public abstract ICrossCommand ToCommand(object owner);
        ...
        public class CrossCommandBuilder : MvxBaseCommandBuilder
        {
            ...
            public override ICrossCommand ToCommand(object owner)
            {
                ...
                return new CrossCommand(executeAction, canExecuteFunc);
            }
        }
