...
public class MacViewPresenterManager
    : CrossViewPresenterManager, IMacViewPresenterManager
{
    ...
    {
        Logger.LogWarning($"PresentationAttribute not found for {request.ViewType.Name}. Assuming new window presentation");
