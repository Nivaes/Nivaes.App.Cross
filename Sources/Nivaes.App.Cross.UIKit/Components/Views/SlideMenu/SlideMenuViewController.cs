...
using CoreGraphics;
using Nivaes.iOS.Core;
using ObjCRuntime;
using UIKit;

namespace Nivaes.App.Cross.UIKitLib
{
    public partial class SlideMenuViewController
        : UIViewController
    {
        #region Values
        private struct SlideMenuOptions
        {
            public static nfloat LeftViewWidth = 320.0f;
            ...
            public static nfloat RightViewWidth = 320f;
        ...
        public SlideAnimation AnimationType
        {
            ...
            set => SlideMenuOptions.AnimationType = value;
        }
        #endregion

        #region Constructors
        public SlideMenuViewController(UIViewController mainViewcontroller, UIViewController leftViewController,
        ...
        {
            MainContainerView = new UIView(base.View.Bounds)
            {
                BackgroundColor = UIColor.Clear,
                AutoresizingMask = UIViewAutoresizing.FlexibleHeight | UIViewAutoresizing.FlexibleWidth
            };
            base.View.InsertSubview(MainContainerView, 0);
            ...
            {
                BackgroundColor = SlideMenuOptions.OpacityViewBackgroundColor,
                AutoresizingMask = UIViewAutoresizing.FlexibleHeight | UIViewAutoresizing.FlexibleWidth
            };
            OpacityView.Layer.Opacity = 0.0f;
            base.View.InsertSubview(OpacityView, 1);
        ...
        #region Open and close controller
        ...
        #region Add and remove gestures
        ...
        private nfloat LeftMinOrigin()
        {
            return -SlideMenuOptions.LeftViewWidth;
        }

        private nfloat RightMinOrigin()
        {
        ...
        {
            if (panGesture == null) throw new ArgumentNullException(nameof(panGesture));
        ...
        #region If left/right open/hidden 
        ...
        #region Open/Close Left/Right with velocity
        public void OpenLeftWithVelocity(nfloat velocity)
        {
            ...
            if (velocity != 0)
            {
                duration = NMath.Abs(xOrigin - finalXOrigin) / velocity;
                duration = NMath.Max(0.1f, NMath.Min(1.0f, duration));
            }
        ...
        public void OpenRightWithVelocity(nfloat velocity)
        {
            ...
            if (velocity != 0)
            {
                duration = NMath.Abs(xOrigin - View.Bounds.Width) / velocity;
                duration = NMath.Max(0.1f, NMath.Min(1.0f, duration));
            }
        ...
        public void CloseRightWithVelocity(nfloat velocity)
        {
            ...
            UIView.Animate(duration, 0.0f, 0,
                ...
                () =>
                {
                    ...
                    RightDidClose?.Invoke();
                });
        }
        #region

        #endregion Change Left/Right/Main controller
        ...
        PanInfo PanLeftResultInfoForVelocity(CGPoint velocity)
        {
            ...
            nfloat PointOfNoReturn = NMath.Floor(LeftMinOrigin()) + SlideMenuOptions.PointOfNoReturnWidth;
        ...
        {
            nfloat ThresholdVelocity = -1000.0f;
            nfloat PointOfNoReturn = NMath.Floor(View.Bounds.Width) - SlideMenuOptions.PointOfNoReturnWidth;
        ...
        private async void InitializeWindowsLevel()
        {
        ...
        void SetUpViewController(UIView targetView, UIViewController targetViewController)
        {
            ...
            {
                base.AddChildViewController(targetViewController);
