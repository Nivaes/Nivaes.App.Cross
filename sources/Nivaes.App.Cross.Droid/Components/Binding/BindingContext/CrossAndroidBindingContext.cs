namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossAndroidBindingContext
        : CrossBindingContext, ICrossAndroidBindingContext
    {
...
#pragma warning restore S4487
        ...
        public CrossAndroidBindingContext(Context context, ICrossLayoutInflaterHolder layoutInflaterHolder, object? source = null)
            : base(source)
        {
        ...
        public ICrossLayoutInflaterHolder LayoutInflaterHolder { get; set; }
