namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossSpinnerSelectedItemBinding
        : CrossAndroidTargetBinding
    {
        protected CrossSpinner? Spinner => (CrossSpinner?)Target;

        private object? _currentValue;
        private CrossAndroidTargetEventSubscription<AdapterView, AdapterView.ItemSelectedEventArgs>? _subscription;

        public CrossSpinnerSelectedItemBinding(CrossSpinner spinner)
            : base(spinner)
        {
        }
        ...
        {
            var spinner = (CrossSpinner)target;
