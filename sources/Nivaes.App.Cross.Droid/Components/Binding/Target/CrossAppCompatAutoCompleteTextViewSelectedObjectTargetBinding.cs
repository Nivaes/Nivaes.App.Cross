namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossAppCompatAutoCompleteTextViewSelectedObjectTargetBinding
        : MvxAndroidPropertyInfoTargetBinding<CrossAppCompatAutoCompleteTextView>
    {
        private IDisposable _subscription;

        public CrossAppCompatAutoCompleteTextViewSelectedObjectTargetBinding(object target, PropertyInfo targetPropertyInfo)
