namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossImageViewImageTargetBinding
        : CrossBaseImageViewTargetBinding
    {
        public CrossImageViewImageTargetBinding(ImageView imageView) : base(imageView) { }
