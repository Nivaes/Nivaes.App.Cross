namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossAxmlNameViewTypeResolver : CrossLongLowerCaseViewTypeResolver, ICrossAxmlNameViewTypeResolver
    {
        public CrossAxmlNameViewTypeResolver(IMvxTypeCache typeCache)
            : base(typeCache)
        {
