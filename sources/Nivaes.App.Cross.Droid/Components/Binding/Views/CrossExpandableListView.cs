namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossExpandableListView : ExpandableListView
    {
        ...
        public CrossExpandableListView(Context context, IAttributeSet attrs)
            : this(context, attrs, new CrossExpandableListAdapter(context))
        {
        }

        public CrossExpandableListView(Context context, IAttributeSet attrs, CrossExpandableListAdapter adapter)
            : base(context, attrs)
        {
            if (adapter == null)
                return;

            var groupTemplateId = CrossAttributeHelpers.ReadGroupItemTemplateId(context, attrs);
        ...
        protected CrossExpandableListView(IntPtr javaReference, JniHandleOwnership transfer)
