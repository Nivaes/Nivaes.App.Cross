...
namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossAppCompatSpinner : AppCompatSpinner
    {
        public CrossAppCompatSpinner(Context context, IAttributeSet attrs)
            : this(context, attrs,
                new CrossAdapter(context)
                {
        ...
        public CrossAppCompatSpinner(Context context, IAttributeSet attrs, ICrossAdapter adapter)
            : base(context, attrs)
        {
            var itemTemplateId = CrossAttributeHelpers.ReadListItemTemplateId(context, attrs);
            var dropDownItemTemplateId = CrossAttributeHelpers.ReadDropDownListItemTemplateId(context, attrs);
        ...
        protected CrossAppCompatSpinner(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        public new ICrossAdapter Adapter
        {
            get => base.Adapter as ICrossAdapter;
            set
            {
