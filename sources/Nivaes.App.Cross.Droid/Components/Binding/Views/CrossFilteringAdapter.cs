namespace Nivaes.App.Cross.Droid
{
        ...
        : CrossAdapter, IFilterable
    {
        ...
        {
            private readonly CrossFilteringAdapter _owner;

            public MyFilter(CrossFilteringAdapter owner)
            {
                _owner = owner;
            }
        ...
        public CrossFilteringAdapter(Context context) : this(context, CrossAndroidBindingContextHelpers.Current())
        {
        }

        public CrossFilteringAdapter(Context context, ICrossAndroidBindingContext bindingContext) : base(context, bindingContext)
        {
        ...
        protected CrossFilteringAdapter(IntPtr javaReference, JniHandleOwnership transfer)
