...
namespace Nivaes.App.Cross.Droid
{
        ...
        : GridView
    {
        ...
        public CrossGridView(Context context, IAttributeSet attrs)
            : this(context, attrs, new CrossAdapter(context))
        {
        }

        public CrossGridView(Context context, IAttributeSet attrs, ICrossAdapter adapter)
            : base(context, attrs)
        {
        ...
        protected CrossGridView(IntPtr javaReference, JniHandleOwnership transfer)
