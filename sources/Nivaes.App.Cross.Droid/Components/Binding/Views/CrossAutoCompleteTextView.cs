...
namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossAutoCompleteTextView
        : AutoCompleteTextView
    {
        public CrossAutoCompleteTextView(Context context, IAttributeSet attrs)
            : this(context, attrs, new CrossFilteringAdapter(context))
        {
        }

        public CrossAutoCompleteTextView(Context context, IAttributeSet attrs,
                                       CrossFilteringAdapter adapter)
            : base(context, attrs)
        {
        ...
        protected CrossAutoCompleteTextView(IntPtr javaReference, JniHandleOwnership transfer)
