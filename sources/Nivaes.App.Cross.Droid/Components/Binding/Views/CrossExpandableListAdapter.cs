...
{
    public class CrossExpandableListAdapter : CrossAdapter, IExpandableListAdapter
    {
        public CrossExpandableListAdapter(Context context)
            : base(context)
        {
        }

        public CrossExpandableListAdapter(Context context, ICrossAndroidBindingContext bindingContext)
            : base(context, bindingContext)
        {
        }

        protected CrossExpandableListAdapter(IntPtr javaReference, JniHandleOwnership transfer)
