namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossLayoutInflater : LayoutInflater
    {
        public class MvxBindingVisitor
        {
            ...
            public ICrossLayoutInflaterHolderFactory? Factory { get; set; }
        ...
        private ICrossLayoutInflaterHolderFactoryFactory? _layoutInflaterHolderFactoryFactory;
        ...
        {
            if (Debug)
                CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView 3 ... {Name}", Tag, name);
        ...
        {
            if (Debug)
                CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView 2 ... {Name}", Tag, name);
        ...
        {
            if (Debug)
                CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView 4 ... {Name}", Tag, name);
        ...
        {
            if (Debug)
                CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... PhoneLayoutInflaterOnCreateView ... {Name}", Tag, name);
        ...
        public void setFactory(IFactory factory)
        {
            ...
            if (!(factory is CrossLayoutInflaterCompat.FactoryWrapper))
            {
                Factory = new CrossLayoutInflaterCompat.FactoryWrapper(new DelegateFactory1(factory, _bindingVisitor));
                return;
            }
        ...
        {
            // Wrap the incoming factory if we need to.
            if (!(factory2 is CrossLayoutInflaterCompat.FactoryWrapper2))
            {
                Factory2 = new CrossLayoutInflaterCompat.FactoryWrapper2(new DelegateFactory2(factory2, _bindingVisitor));
                return;
            }
        ...
        private void SetupLayoutFactories(bool cloned)
        {
            ...
            if (Factory2 != null && !(Factory2 is CrossLayoutInflaterCompat.FactoryWrapper2))
            {
                CrossLayoutInflaterCompat.SetFactory(this, new DelegateFactory2(Factory2, _bindingVisitor));
            }
        }
        ...
        private void SetPrivateFactoryInternal()
        {
            ...
            {
                CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Warning, ex, "Cannot invoke LayoutInflater.setPrivateFactory");
            }
        ...
        {
            if (Debug)
                CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... CreateCustomViewInternal ... {Name}", Tag, name);
        ...
        protected ICrossAndroidViewFactory? AndroidViewFactory
        {
            get
            {
        ...
        protected ICrossLayoutInflaterHolderFactoryFactory? FactoryFactory
        {
            get
            {
        ...
        private sealed class DelegateFactory2 : ICrossLayoutInflaterFactory
        {
            ...
            {
                if (Debug)
                    CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView ... {Name}", DelegateFactory2Tag, name);
        ...
        private sealed class DelegateFactory1 : ICrossLayoutInflaterFactory
        {
            ...
            {
                if (Debug)
                    CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView ... {Name}", DelegateFactory1Tag, name);
...
#pragma warning restore 8618
            ...
            {
                if (Debug)
                    CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView 2 ... {Name}", PrivateFactoryWrapper2Tag, name);
            ...
            {
                if (Debug)
                    CrossLogHost.GetLog<CrossLayoutInflater>()?.Log(LogLevel.Trace, "{Tag} - ... OnCreateView 3 ... {Name}", PrivateFactoryWrapper2Tag, name);
