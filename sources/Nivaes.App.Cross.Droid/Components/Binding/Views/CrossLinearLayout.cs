namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossLinearLayout
        : LinearLayout, ICrossWithChangeAdapter
    {
        public CrossLinearLayout(Context context, IAttributeSet attrs)
            : this(context, attrs, new CrossAdapterWithChangedEvent(context))
        {
        }

        public CrossLinearLayout(Context context, IAttributeSet attrs, ICrossAdapterWithChangedEvent adapter)
            : base(context, attrs)
        {
        ...
        protected CrossLinearLayout(IntPtr javaReference, JniHandleOwnership transfer)
