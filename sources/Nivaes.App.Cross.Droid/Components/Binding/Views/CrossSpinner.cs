...
namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossSpinner : Spinner
    {
        public CrossSpinner(Context context, IAttributeSet attrs)
            : this(
                context, attrs,
        ...
        public CrossSpinner(Context context, IAttributeSet attrs, ICrossAdapter adapter)
            : base(context, attrs)
        {
        ...
        protected CrossSpinner(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        public new ICrossAdapter Adapter
        {
            get
            {
                return base.Adapter as ICrossAdapter;
            }
            set
            {
