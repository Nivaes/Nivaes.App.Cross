namespace Nivaes.App.Cross.Droid
{
        ...
        : ListView
    {
        ...
        public CrossListView(Context context, IAttributeSet attrs)
            : this(context, attrs, new CrossAdapter(context))
        {
        }

        public CrossListView(Context context, IAttributeSet attrs, ICrossAdapter adapter)
            : base(context, attrs)
        {
        ...
        protected CrossListView(IntPtr javaReference, JniHandleOwnership transfer)
