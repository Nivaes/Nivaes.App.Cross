...
namespace Nivaes.App.Cross.Droid
{
    ...
    {
        private static readonly Lazy<ICrossAndroidBindingResource> mvxAndroidBindingResource = new Lazy<ICrossAndroidBindingResource>(() => Mvx.IoCProvider.GetSingleton<ICrossAndroidBindingResource>());
