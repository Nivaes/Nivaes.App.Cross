...
namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossAppCompatAutoCompleteTextView
        : AppCompatAutoCompleteTextView
    {
        public CrossAppCompatAutoCompleteTextView(Context context, IAttributeSet attrs)
            : this(context, attrs, new CrossFilteringAdapter(context))
        {
        }

        public CrossAppCompatAutoCompleteTextView(Context context, IAttributeSet attrs,
            CrossFilteringAdapter adapter) : base(context, attrs)
        {
        ...
        protected CrossAppCompatAutoCompleteTextView(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        public new CrossFilteringAdapter Adapter
        {
            get
            {
                return base.Adapter as CrossFilteringAdapter;
            }
            set
            {
