...
namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossTimePicker
        : TimePicker
        , TimePicker.IOnTimeChangedListener
    {
        private bool _initialized;

        public CrossTimePicker(Context context)
            : base(context)
        {
        }

        public CrossTimePicker(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
        }

        public CrossTimePicker(Context context, IAttributeSet attrs, int defStyleAttr)
            : base(context, attrs, defStyleAttr)
        {
        }

        public CrossTimePicker(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes)
            : base(context, attrs, defStyleAttr, defStyleRes)
        {
        }

        protected CrossTimePicker(IntPtr javaReference, JniHandleOwnership transfer)
