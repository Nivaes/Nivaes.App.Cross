namespace Nivaes.App.Cross.Droid
{
    ...
    public abstract class CrossCachingFragmentPagerAdapter : PagerAdapter
    {
        ...
        protected CrossCachingFragmentPagerAdapter(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        protected CrossCachingFragmentPagerAdapter(FragmentManager fragmentManager)
        {
...
#if DEBUG
            CrossLogHost.GetLog<CrossCachingFragmentPagerAdapter>()?.Log(LogLevel.Trace,
