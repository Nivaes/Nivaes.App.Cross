namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossCachingFragmentStatePagerAdapter : CrossCachingFragmentPagerAdapter
    {
        public const string ViewPagerFragmentsInfoBundleKey = "__mvxViewPagerFragmentsInfo";

        private readonly Type _activityType;

        public List<CrossViewPagerFragmentInfo> FragmentsInfo { get; }
        ...
        protected CrossCachingFragmentStatePagerAdapter(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        [UnconditionalSuppressMessage("Trimming", "IL2072", Justification = "Activity types are preserved by the Android presenter infrastructure.")]
        public CrossCachingFragmentStatePagerAdapter(FragmentManager fragmentManager,
            List<CrossViewPagerFragmentInfo> fragmentsInfo) : base(fragmentManager)
        {
            throw new NotImplementedException();
        ...
        private static ICrossViewModel GetViewModel(CrossViewPagerFragmentInfo fragmentInfo)
        {
            throw new NotImplementedException();
        ...
        private static Bundle GetArguments(CrossViewPagerFragmentInfo fragmentInfo)
        {
            throw new NotImplementedException();
