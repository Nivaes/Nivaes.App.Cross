namespace Nivaes.App.Cross.Droid
{
    ...
    public sealed class CrossActionBarDrawerToggle : ActionBarDrawerToggle
    {
        public CrossActionBarDrawerToggle(IntPtr handle, JniHandleOwnership ownership)
            : base(handle, ownership)
        {
        }

        public CrossActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, int openDrawerContentDescRes,
            int closeDrawerContentDescRes)
            : base(activity, drawerLayout, openDrawerContentDescRes, closeDrawerContentDescRes)
        {
        }

        public CrossActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, Toolbar toolbar,
