namespace Nivaes.App.Cross.Droid
{
    ...
    public static class CrossFragmentExtensions
    {
        ...
        public static void OnCreate(this ICrossFragmentView fragmentView, IMvxBundle bundle, CrossViewModelRequest? request = null)
        {
            ...
            if (fragment == null)
                throw new MvxException($"{nameof(OnCreate)} called on an {nameof(ICrossFragmentView)} which is not an Android Fragment: {fragmentView}");
        ...
        public static void EnsureBindingContextIsSet(this ICrossFragmentView fragment, LayoutInflater inflater)
        {
            ...
            if (actualFragment == null)
                throw new MvxException($"{nameof(EnsureBindingContextIsSet)} called on an {nameof(ICrossFragmentView)} which is not an Android Fragment: {fragment}");
        ...
        public static void LoadViewModelFrom(this ICrossFragmentView view, CrossViewModelRequest request, IMvxBundle? savedState = null)
        {
