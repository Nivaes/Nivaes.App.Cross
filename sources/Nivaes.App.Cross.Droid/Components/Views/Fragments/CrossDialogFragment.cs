namespace Nivaes.App.Cross.Droid.Fragments
{
    using System.Diagnostics.CodeAnalysis;
    using Android.Runtime;

    [Register("mvvmcross.platforms.android.views.fragments.MvxDialogFragment")]
    public abstract class CrossDialogFragment
        : CrossEventSourceDialogFragment, ICrossFragmentView
    {
        protected CrossDialogFragment(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        [RequiresUnreferencedCode("This constructor uses reflection which may not be preserved during trimming.")]
        protected CrossDialogFragment()
        {
    ...
    public abstract class CrossDialogFragment<TViewModel> 
        : CrossDialogFragment, ICrossFragmentView<TViewModel>
        where TViewModel : class, ICrossViewModel
    {
        ...
        protected CrossDialogFragment(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }
