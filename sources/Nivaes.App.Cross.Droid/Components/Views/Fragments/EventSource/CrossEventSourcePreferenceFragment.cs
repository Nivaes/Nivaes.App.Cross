namespace Nivaes.App.Cross.Droid
{
    ...
    [Register("Nivaes.App.Cross.Droid.CrossEventSourcePreferenceFragment")]
    public abstract class CrossEventSourcePreferenceFragment : PreferenceFragment
    , ICrossEventSourceFragment
    {
        ...
        public event EventHandler<CrossValueEventArgs<CrossCreateViewParameters>>? CreateViewCalled;
        ...
        public CrossEventSourcePreferenceFragment()
        {
        }

        public CrossEventSourcePreferenceFragment(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        {
            CreateViewCalled?.Raise(this, new CrossCreateViewParameters(inflater, container, savedInstanceState));
