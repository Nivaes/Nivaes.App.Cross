namespace Nivaes.App.Cross.Droid.Fragments.EventSource
{
    ...
    public class CrossEventSourceListFragment
        : ListFragment
        , ICrossEventSourceFragment
    {
        ...
        protected CrossEventSourceListFragment()
        {
        }

        protected CrossEventSourceListFragment(IntPtr javaReference, JniHandleOwnership transfer)
