namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossEventSourceFragment
        : Fragment
        , ICrossEventSourceFragment
    {
        ...
        protected CrossEventSourceFragment()
        {
        }

        protected CrossEventSourceFragment(IntPtr javaReference, JniHandleOwnership transfer)
