namespace Nivaes.App.Cross.Droid
{
    ...
    public class CrossEventSourceDialogFragment
        : DialogFragment
        , ICrossEventSourceFragment
    {
        ...
        protected CrossEventSourceDialogFragment()
        {
        }

        protected CrossEventSourceDialogFragment(IntPtr javaReference, JniHandleOwnership transfer)
