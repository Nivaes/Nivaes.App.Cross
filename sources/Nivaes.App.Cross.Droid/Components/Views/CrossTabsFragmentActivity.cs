namespace Nivaes.App.Cross.Droid
{
    ...
    public abstract class CrossTabsFragmentActivity
        : CrossActivity<CrossNullViewModel>, TabHost.IOnTabChangeListener
    {
        ...
        protected CrossTabsFragmentActivity(int layoutId, int tabContentId)
        {
            _layoutId = layoutId;
        ...
        private static void AddTab(CrossTabsFragmentActivity activity,
                                   TabHost tabHost,
