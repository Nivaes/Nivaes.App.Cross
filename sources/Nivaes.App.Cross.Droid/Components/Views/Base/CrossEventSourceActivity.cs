namespace Nivaes.App.Cross.Droid
{
        ...
        : Activity, ICrossEventSourceActivity
    {
        ...
        {
            StartActivityForResultCalled?.Raise(this, new CrossStartActivityForResultParameters(intent, requestCode));
            base.StartActivityForResult(intent, requestCode);
        }

        protected override void OnActivityResult(int requestCode, Android.App.Result resultCode, Intent? data)
        {
            ActivityResultCalled?.Raise(this, new CrossActivityResultParameters(requestCode, resultCode, data));
        ...
        public event EventHandler<CrossValueEventArgs<CrossStartActivityForResultParameters>>? StartActivityForResultCalled;

        public event EventHandler<CrossValueEventArgs<CrossActivityResultParameters>>? ActivityResultCalled;
    }
}
