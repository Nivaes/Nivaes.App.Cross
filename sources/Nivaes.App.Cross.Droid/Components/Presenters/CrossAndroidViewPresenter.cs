...
//    public class CrossAndroidViewPresenter : MvxAttributeViewPresenter, IMvxAndroidViewPresenter
//    {
...
//            new(() => throw new NotImplementedException() /*Mvx.IoCProvider?.Resolve<ICrossAndroidCurrentTopActivity>()*/);

//        private readonly Lazy<ICrossAndroidActivityLifetimeListener?> _activityLifetimeListener =
//            new(() => throw new NotImplementedException() /*Mvx.IoCProvider?.Resolve<ICrossAndroidActivityLifetimeListener>()*/);

//        private readonly Lazy<ICrossNavigationSerializer?> _navigationSerializer =
//            new(() => throw new NotImplementedException() /*Mvx.IoCProvider?.Resolve<IMvxNavigationSerializer>()*/);

//        private readonly Lazy<ILogger?> _logger = new(() => MvxLogHost.GetLog<CrossAndroidViewPresenter>());
...
//        public CrossAndroidViewPresenter(IEnumerable<Assembly> androidViewAssemblies)
//        {
