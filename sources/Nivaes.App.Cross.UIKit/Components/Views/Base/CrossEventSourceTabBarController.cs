namespace Nivaes.App.Cross.UIKit
{
    ...
    public class CrossEventSourceTabBarController
        : UITabBarController, ICrossEventSourceViewController
    {
        public CrossEventSourceTabBarController() : base()
        {
        }

        public CrossEventSourceTabBarController(NSCoder coder) : base(coder)
        {
        }

        protected CrossEventSourceTabBarController(NSObjectFlag t) : base(t)
        {
        }

        protected internal CrossEventSourceTabBarController(NativeHandle handle) : base(handle)
        {
        }

        public CrossEventSourceTabBarController(string nibName, NSBundle bundle) : base(nibName, bundle)
        {
        }
