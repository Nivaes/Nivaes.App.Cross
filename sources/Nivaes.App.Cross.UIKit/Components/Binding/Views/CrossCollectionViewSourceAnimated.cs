namespace Nivaes.App.Cross.UIKit
{
    ...
    public class CrossCollectionViewSourceAnimated : CrossCollectionViewSource
    {
        private readonly object collectionChangedLock = new object();
        private readonly ILogger<CrossCollectionViewSourceAnimated> _logger;
        ...
        public CrossCollectionViewSourceAnimated(UICollectionView collectionView)
            : base(collectionView)
        {
            _logger = CrossLogHost.GetLog<CrossCollectionViewSourceAnimated>();
        }

        public CrossCollectionViewSourceAnimated(UICollectionView collectionView, NSString defaultCellIdentifier)
