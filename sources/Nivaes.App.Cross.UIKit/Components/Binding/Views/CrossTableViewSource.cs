namespace Nivaes.App.Cross.UIKit
{
    ...
    public abstract class CrossTableViewSource : CrossBaseTableViewSource
    {
        private IEnumerable _itemsSource;
        private IDisposable _subscription;

        protected CrossTableViewSource(UITableView tableView)
            : base(tableView)
        {
        }

        protected CrossTableViewSource(NativeHandle handle)
            : base(handle)
        {
