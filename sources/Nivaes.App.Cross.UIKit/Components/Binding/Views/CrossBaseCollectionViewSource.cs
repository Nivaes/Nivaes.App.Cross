namespace Nivaes.App.Cross.UIKit
{
    ...
    public abstract class CrossBaseCollectionViewSource : UICollectionViewSource
    {
        ...
        protected CrossBaseCollectionViewSource(UICollectionView collectionView)
...
#pragma warning restore S1168 // Empty arrays and collections should be returned instead of null
        ...
        public virtual void ReloadData()
        {
            ...
            {
                CrossLogHost.GetLog<CrossBaseCollectionViewSource>()?.Log(LogLevel.Warning, exception,
