namespace Nivaes.App.Cross.UIKit
{
    ...
    public class CrossUIControlTargetBinding : CrossConvertingTargetBinding
    {
        ...
        private CrossWeakEventSubscription<UIControl>? _controlEventSubscription;

        protected UIControl? Control => Target as UIControl;

        public CrossUIControlTargetBinding(UIControl control, string controlEvent)
            : base(control)
        {
