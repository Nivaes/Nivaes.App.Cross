namespace Nivaes.App.Cross.UIKit
{
    ...
    public abstract class CrossBaseUIDatePickerTargetBinding(
            UIDatePicker target,
            PropertyInfo targetPropertyInfo)
        : CrossPropertyInfoTargetBinding<UIDatePicker>(target, targetPropertyInfo)
    {
        ...
        public override void SubscribeToEvents()
        {
            ...
            if (datePicker == null)
            {
                CrossBindingLog.Instance?.LogError("UIDatePicker is null in {TargetBindingType}",
                    nameof(CrossBaseUIDatePickerTargetBinding));
            }
