namespace MvvmCross.Platforms.Tvos.Presenters
{
        ...
        : MvxAttributeViewPresenter, IMvxTvosViewPresenter
    {
        ...
        protected virtual Task<bool> CloseRootViewController(ICrossViewModel viewModel,
        ...
        protected virtual Task<bool> CloseModalViewController(ICrossViewModel viewModel,
        ...
        protected virtual async Task<bool> CloseMasterSplitViewController(ICrossViewModel viewModel, MvxMasterDetailPresentationAttribute attribute)
        {
        ...
        protected virtual async Task<bool> CloseDetailSplitViewController(ICrossViewModel viewModel, MvxMasterDetailPresentationAttribute attribute)
        {
        ...
        public virtual Task<bool> CloseChildViewModel(ICrossViewModel viewModel)
        {
