namespace Nivaes.App.Cross
{
    ...
    public class CrossCoreBindingBuilder
    {
        ...
        protected virtual void FillValueCombiners(ICrossValueCombinerRegistry registry)
        {
            ...
            registry.AddOrOverwrite("NotEqualTo", new CrossNotEqualToValueCombiner());
            ...
            registry.AddOrOverwrite("Not", new CrossNotValueCombiner());
            registry.AddOrOverwrite("And", new CrossAndValueCombiner());
            registry.AddOrOverwrite("Or", new CrossOrValueCombiner());
            registry.AddOrOverwrite("XOr", new CrossXorValueCombiner());
            registry.AddOrOverwrite("Inverted", new CrossInvertedValueCombiner());

            // Note: CrossValueConverterValueCombiner is not registered - it is unconventional
