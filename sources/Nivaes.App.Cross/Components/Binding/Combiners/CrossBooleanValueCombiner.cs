...
{
    public class CrossInvertedValueCombiner
    ...
    public class CrossAndValueCombiner
        : CrossBooleanValueCombiner
    {
        protected override bool TryCombine(List<bool> stepValues, out object value)
        {
    ...
    public class CrossOrValueCombiner
        : CrossBooleanValueCombiner
    {
        protected override bool TryCombine(List<bool> stepValues, out object value)
        {
    ...
    public class CrossNotValueCombiner
        : CrossBooleanValueCombiner
    {
        protected override bool TryCombine(List<bool> stepValues, out object value)
        {
    ...
    public class CrossXorValueCombiner
        : CrossBooleanValueCombiner
    {
        protected override bool TryCombine(List<bool> stepValues, out object value)
        {
