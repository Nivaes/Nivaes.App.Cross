namespace Nivaes.App.Cross
{
       ...
       : CrossSingleton<CrossSetupSingleton>
    {
        ...
        /// execution of setup
        /// </summary>
        /// <typeparam name="TCrossSetupSingleton">The platform specific setup singleton type</typeparam>
        /// <returns>A platform specific setup singleton</returns>
        [RequiresUnreferencedCode("This method uses reflection which may not be preserved during trimming")]
        protected static TCrossSetupSingleton? EnsureSingletonAvailable<TCrossSetupSingleton>()
           where TCrossSetupSingleton : CrossSetupSingleton, new()
        {
            // Double null - check before creating the setup singleton object
            if (Instance != null)
                return Instance as TCrossSetupSingleton;
            lock (LockObject)
            {
                if (Instance != null)
                    return Instance as TCrossSetupSingleton;
                ...
                var instance = new TCrossSetupSingleton();
