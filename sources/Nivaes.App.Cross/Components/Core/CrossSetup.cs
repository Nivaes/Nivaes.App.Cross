namespace Nivaes.App.Cross
{
    ...
    public abstract class CrossSetup : ICrossSetup
    {
        ...
        public static void RegisterSetupType<TCrossSetup>(params Assembly[] assemblies) where TCrossSetup : CrossSetup, new()
        {
        ...
        public virtual void InitializePrimary()
        {
            ...
            try
            {
                ...
                //// Developers can either extend the CrossSetup and override
        ...
        public virtual void InitializeSecondary()
        {
            ...
            try
            {
                ...
                //var app = InitializeCrossApplication(_iocProvider);
                ...
                //        nameof(InitializeCrossApplication));
                //}
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        protected virtual void RegisterDefaultSetupDependencies(ICrossIoCProvider iocProvider)
        {
            ...
            //iocProvider.RegisterSingleton<ICrossPluginManager>(() => new CrossPluginManager(iocProvider, GetPluginConfiguration));
        ...
        //protected virtual ICrossIocOptions CreateIocOptions()
        //{
        //    return new CrossIocOptions();
        //}
        ...
        //[RequiresUnreferencedCode("This method uses reflection to check for referenced assemblies, which may not be preserved by trimming")]
        //protected virtual ICrossPluginManager? InitializePluginFramework(IMvxIoCProvider iocProvider)
        //{
        //    ValidateArguments(iocProvider);
        ...
        //protected virtual ICrossPluginManager? CreatePluginManager(IMvxIoCProvider iocProvider)
        //{
        //    ValidateArguments(iocProvider);

        //    return iocProvider.Resolve<ICrossPluginManager>();
        //}

        //protected virtual ICrossPluginConfiguration? GetPluginConfiguration(Type plugin)
        //{
        //    return null;
        //}
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        //    var pluginAttribute = typeof(CrossPluginAttribute);
        ...
        protected virtual ICrossApplication? InitializeCrossApplication(ICrossIoCProvider iocProvider)
        {
            ...
            //var app = CreateCrossApplication(iocProvider);
            //if (app != null)
