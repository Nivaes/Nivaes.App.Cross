namespace Nivaes.App.Cross.WinUI3
{
    ...
    public class CrossWindowsBindingCreator : CrossBindingCreator
    {
                                            ...
                                            FrameworkElement attachedObject)
        {
            ...
            {
                CrossLogHost.GetLog<CrossWindowsBindingCreator>()?.Log(LogLevel.Warning,
        ...
        protected static IValueConverter GetConverter(ICrossValueConverter converter)
        {
            ...
            return new CrossNativeValueConverter(converter);
        }
