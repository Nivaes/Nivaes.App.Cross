namespace Nivaes.App.Cross.WinUI3
{
        ...
        : ICrossSuspensionManager
    {
        ...
        {
            if (frame.GetValue(CrossFrameSessionStateKeyProperty) != null)
            {
                throw new InvalidOperationException("Frames can only be registered to one session state key");
            }

            if (frame.GetValue(CrossFrameSessionStateProperty) != null)
            {
            ...
            frame.SetValue(CrossFrameSessionStateKeyProperty, sessionStateKey);
        ...
        {
            var frameState = (Dictionary<string, object>)frame.GetValue(CrossFrameSessionStateProperty);

            if (frameState == null)
            {
                var frameSessionKey = (string)frame.GetValue(CrossFrameSessionStateKeyProperty);
                ...
                frame.SetValue(CrossFrameSessionStateProperty, frameState);
            }
            return frameState;
        }
